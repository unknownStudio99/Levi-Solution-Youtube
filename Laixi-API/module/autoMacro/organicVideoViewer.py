...
def watchOrganicVideo(targetKeyword, videoUrl, durationPercent, targetDevices, wsUrl, deviceManager):
    """
    지정된 유튜브 영상을 시청하는 함수
    ...
    try:
        # 랜덤 키워드 검색
        randomSearch(targetKeyword, targetDevices, wsUrl, deviceManager)
